...
@section('header', 'Tạo Vai trò & Gán quyền')
...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('roles.store') }}" method="POST">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="VD: Kế toán kho, Giám sát...">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                <h3 class="font-bold text-gray-700">Danh sách quyền hạn</h3>
                <div class="text-xs text-gray-500">Chọn các chức năng mà vai trò này được phép truy cập</div>
            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-start cursor-pointer hover:bg-white p-1 rounded transition">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="permission_ids[]" value="{{ $perm->id }}" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                            </div>
        ...
        <div class="flex justify-end gap-3 mt-6">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium shadow-sm">Lưu Vai trò</button>
        </div>
    </form>
</div>
@endsection