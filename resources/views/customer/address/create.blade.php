...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-black text-gray-800">Thêm Địa Chỉ Giao Hàng</h1>
        <p class="text-gray-600 mt-2">Nhập thông tin địa chỉ mới của bạn</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('customer.address.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select id="district" onchange="loadWards(this.value)" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required disabled>
            ...
            <div>
                ...
                <select id="ward_id" name="ward_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required disabled>
            ...
            <div>
                ...
                <textarea name="detail" id="detail" rows="4" placeholder="Nhập số nhà, tên đường, tòa nhà, etc." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>{{ old('detail') }}</textarea>
            ...
            <div class="flex gap-3 pt-4">
                ...
                <button type="submit" class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg font-bold hover:bg-blue-700 transition">
                    <i class="fa-solid fa-save mr-2"></i>Lưu Địa Chỉ
                </button>
            </div>
        </form>
    </div>
