...
## 3️⃣ RESET & LÀM SẠCH HỆ THỐNG (KHI CẦN)
...
## 5️⃣ CÀI ĐẶT FRONTEND (VITE + TAILWIND)
...
## 7️⃣ TÓM TẮT LỆNH CHẠY CHUẨN (DEV)
...
* ❌ **Không dùng CDN Tailwind** (`cdn.tailwindcss.com`)
* ✅ CSS/JS phải load qua `@vite(...)`
* ✅ Dev local **bắt buộc chạy song song**:
